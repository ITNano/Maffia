...
app.all('/', function(req, res){ res.sendFile(__dirname+'/index.html'); });
app.get('/jquery.js', function(req, res){ res.sendFile(__dirname+'/external/jquery.js'); });
app.get('/imgs/settings.png', function(req, res){ res.sendFile(__dirname+'/imgs/settings.png'); });

//Init array of auto generated names.
fs.readFile('data/autogeneratednames.txt', 'utf-8', function(err, data){
	if(err){
